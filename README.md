...
常驻桌面、始终置顶，背景会按照本周剩余额度比例填充：

<img src="assets/screenshots/compact-pill.png" alt="Codex Float 悬浮胶囊，显示 95% 剩余额度" width="308">

### 展开详情

点击胶囊后展示剩余额度、距重置时间、重置日期、当前套餐和重置机会：

<img src="assets/screenshots/expanded-panel.png" alt="Codex Float 展开详情面板" width="372">
